...
const page = async ({ params }: Props) => {
  ...
  const prices = await stripe.prices.list({
    product: process.env.NEXT_HYDRA_PRODUCT_ID,
    active: true,
  })
    ...
    <>
      ...
      <div className="flex flex-col lg:!flex-row justify-between gap-8">
        <PricingCard
          ...
          highlightDescription="Want to customize your plan? Or have
          further question contact support@hydrainfo.com"
          ...
          features={
            agencySubscription?.Subscription?.active === true
              ...
              : currentPlanDetails?.features ||
                pricingCards.find((pricing) => pricing.title === 'Free')
                  ?.features ||
                []
          }
          title={
            agencySubscription?.Subscription?.active === true
              ? currentPlanDetails?.title || 'Free'
              : 'Free'
          }
        />
